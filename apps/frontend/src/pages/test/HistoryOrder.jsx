    ...
    <>
      ...
      <div className=" border-gray-300 bg-white shadow-lg p-6 rounded-lg m-10">
        ...
        <div className="flex flex-row justify-between p-4">
          <div className="text-xl font-bold">Order#ID001 <span className="text-xs text-gray-400"> Dec 16, 2024 14:13</span> </div>
          <div className="text-xl font-bold text-[#23C60E] ml-auto">Complete</div>
        </div>
        ...
        <div className="grid grid-cols-5 gap-2 mt-5 p-4">
          ...
          <div className="flex flex-col gap-2 col-span-2 col-start-3 ml-[30%]">
            <div className="text-2xl font-semibold text-[#EF233C]">รายละเอียดการจัดส่ง</div>
            <div className="text-xs"><span className="text-xl font-semibold">ชื่อลูกค้า:</span> sud lor CS</div>
            <div className="text-xs">หอ Grove residence วงศ์สว่าง11 ห้อง 314</div>
          </div>

          <div className="flex flex-col gap-2 col-span-1 col-start-5">
            <div className="text-2xl font-semibold text-[#EF233C] text-end">สรุปรายการ</div>

            <div className="self-end"><button className="btn bg-[#2B2D42] rounded-full text-white text-xs p-4" onClick={() => document.getElementById('my_modal_1').showModal()}>ดูเพิ่มเติม</button>
              <dialog id="my_modal_1" className="modal">
                <div className="modal-box max-w-2xl p-5  rounded-xl shadow-lg">

                  <div className="flex justify-between ">
                    <div className="flex flex-col">
                      <div className="text-2xl">Order <span className=" text-gray-500">#ID001</span></div>
                    ...
                    <div className="flex flex-col items-end gap-2">
                      ...
                      <div className="w-[80px] mr-[10%]"><button className="btn bg-[#D9D9D9] rounded-full text-[14px] w-full h-min">ดูสลิป</button></div>
                  ...
                  <div className="flex flex-row justify-between mt-5">
                    <div className="flex flex-col gap-1">
                      ...
                      <span className="text-gray-500 text-[13px] mt-1">Delivery Date <span className="text-gray-800">Dec 16, 2024 <span className="text-gray-500"> | ชำระเงินผ่าน <span className="text-gray-800">COD</span> 14:20</span></span></span>
                    </div>
        ...
        <div className="flex flex-row justify-between mt-4 p-4">
          <div className=" text-gray-500 mt-5">Delivery Date <span className="font-semibold text-gray-500">Dec 16, 2024</span> | ชำระเงินผ่าน <span className="font-semibold text-gray-500">COD</span> 14:20  </div>
